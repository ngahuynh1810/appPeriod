...
public class updateDDCKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        String title = i.getExtras().getString("loichao","khong co loi chao");
        String url = i.getExtras().getString("duongdan","khong co duong dan");
    ...
    public void addControl() {
        txtDoDaiKinhNguyet = (TextView) findViewById(R.id.txtDoDaiKinhNguyet);
